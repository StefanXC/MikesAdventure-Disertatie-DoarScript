...
public class MisiuniManager3 : MonoBehaviour
{
    ...
    void Start()
    {
        if (!PlayerPrefs.HasKey("complet2"))
        {
            PlayerPrefs.SetInt("complet2", 0);
            Incarca();
        }
        else
        {
    ...
    {
        PlayerPrefs.SetInt("complet2", complet ? 1 : 0);
        PlayerPrefs.SetInt("b", a);
    }

    private void Incarca()
    {
        complet = PlayerPrefs.GetInt("complet2") == 1;
        a = PlayerPrefs.GetInt("b");
    }
}
